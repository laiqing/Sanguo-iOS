...
@implementation ResourceDragTouchSprite
...
- (BOOL)ccTouchBegan:(UITouch *)touch withEvent:(UIEvent *)event {
    if ( ![self containsTouchLocation:touch] )
    {
        ...
        dragSprite = [ResourceDragSprite spriteWithSpriteFrameName:state0Image];
        dragSprite.scale = 1.2;
        
        dragSprite.resID = touchID;
